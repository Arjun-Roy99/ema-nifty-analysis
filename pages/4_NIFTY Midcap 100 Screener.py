...
st.set_page_config(page_title = "NIFTY 100 Midcap Golden Cross Screener", layout = "wide")
...
def get_tickers():
    ...
    csv_path = os.path.join(os.path.dirname(__file__), "ind_niftymidcap100list.csv")
